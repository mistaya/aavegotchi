    ...
    <div>
      ...
      <div style="margin-bottom: 30px;">
        <div class="site-alertbox site-alertbox--warning">
          ...
          <div>
            Due to a bug with lending data between 13-17 May 2022, the reported <code>timeEnded</code> (and therefore <code>actualPeriod</code>) are now likely to be <b>wrong</b> for lendings that finished during this period, and also for many of the first 25000 lendings (these now incorrectly appear to have finished between 13-17 May).
