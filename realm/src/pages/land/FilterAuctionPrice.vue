...
const getFilter = function (auctionsByParcelId, filterValue) {
  ...
  return function (parcel) {
    ...
    const parcelAuction = auctionsByParcelId[parcel.id]
    if (!parcelAuction) {
      return false
    }
    ...
    const price = parcelAuction.highestBidGhst - 0
